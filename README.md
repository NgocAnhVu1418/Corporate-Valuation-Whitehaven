...
This project was completed as part of the **FINC6021 Corporate Valuation course at The University of Sydney**, where the report achieved **20/20 (High Distinction)**.
...
- Deriving intrinsic equity value

The final goal is to generate an **evidence-based investment recommendation** supported by financial modelling and economic reasoning.
...
Estimated the required return on equity using the **Capital Asset Pricing Model (CAPM)**.

Inputs include:

- Risk-free rate
- Equity beta derived from comparable firms
- Market risk premium
...
Built a full **integrated financial model** including:

- Pro-forma Income Statement (2026E–2030E)
- Pro-forma Balance Sheet
- Working Capital schedule
- Free Cash Flow projections
- Scenario-based revenue and cost assumptions
...
The model ensures accounting consistency through the **balance sheet plug method**.

---

### 6. Weighted Average Cost of Capital (WACC)

Calculated the firm’s WACC using the estimated cost of equity and cost of debt.
...
Future free cash flows were discounted using WACC to derive enterprise value and equity value.
...
However, valuation outcomes remain sensitive to:
